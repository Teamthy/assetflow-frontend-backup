                      ...
                      <tr key={invite.id}>
                        ...
                        <td className="px-6 py-4">
                          <DropdownMenu>
                            ...
                            <DropdownMenuContent align="end">
                              <DropdownMenuItem onClick={() => handleResendInvitation(invite)} disabled={submittingAction === `resend:${invite.id}`}>
                                <RefreshCw className="w-4 h-4 mr-2" />
                                {submittingAction === `resend:${invite.id}` ? 'Resending…' : 'Resend'}
                              </DropdownMenuItem>
                              <DropdownMenuItem className="text-red-600 focus:text-red-700 focus:bg-red-50" onClick={() => setCancelInviteTarget(invite)}>
                                <Trash2 className="w-4 h-4 mr-2" />
                                Cancel
                              </DropdownMenuItem>
                            </DropdownMenuContent>
