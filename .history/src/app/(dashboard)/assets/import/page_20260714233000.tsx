...
export default function ImportAssetsPage() {
  ...
  function validateFile(f: File): boolean {
    ...
    if (!isExcel) {
      setFileError('Only .xlsx or .xls files are supported')
      return false
    }
  ...
  function downloadTemplate() {
    // Generate a simple CSV template client-side for now
    const headers = [
      'name',
      'assetTag',
      'serialNumber',
  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <PageHeader
        ...
        description="Bulk import your existing asset register from Excel"
      />
