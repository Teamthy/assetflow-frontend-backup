...
export default function LoginPage() {
  ...
  const onSubmit = async (data: LoginForm) => {
    ...
    try {
      ...
      // Try to get role from response, fall back to primary_admin as default for account creators
      let role: UserRole =
        responseData?.member?.role ??
        responseData?.role ??
        'primary_admin'  // ← Changed: Account creators should see admin dashboard on return login
