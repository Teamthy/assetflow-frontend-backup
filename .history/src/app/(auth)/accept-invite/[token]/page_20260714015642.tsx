    ...
    try {
      ...
      setAuth({
        user: {
          ...
          fullName: [response.user.firstName, response.user.lastName].filter(Boolean).join(' ') || (response.user as Record<string,unknown>).fullName as string || response.user.email,
