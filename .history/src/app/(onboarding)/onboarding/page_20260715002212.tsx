    ...
    return (
      <div className="space-y-6">
        ...
        <div className="space-y-4">
          {[
            { emoji: '📊', label: 'Import from Excel', badge: 'RECOMMENDED', desc: 'Already have an asset register in Excel? Upload it in minutes.', action: async () => { await router.push('/assets/import?from=onboarding'); onNext() } },
            { emoji: '✏️', label: 'Add assets manually', badge: null, desc: 'Start fresh and add assets one by one.', action: async () => { await router.push('/assets/new?from=onboarding'); onNext() } },
