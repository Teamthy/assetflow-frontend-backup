  ...
  return (
    <div className="space-y-8 rounded-3xl border border-[var(--border-default)] bg-[var(--surface-card)] p-8 shadow-[0_20px_60px_-20px_rgba(15,23,42,0.25)]">
      ...
      <div className="space-y-3">
        ...
        <p className="text-xs text-[var(--neutral-500)]">Assets below this value will be expensed rather than capitalized.</p>
        <div className="grid grid-cols-2 gap-3">
          {THRESHOLDS.map((t) => (
            ...
            >
              ...
              <p className="mt-1 text-xs text-[var(--neutral-500)]">{t.description}</p>
            </motion.button>
          ))}
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 gap-3">
          {DEPRECIATION_METHODS.map((m) => (
            ...
            >
              ...
              <p className="mt-1 text-xs text-[var(--neutral-500)]">{m.description}</p>
            </motion.button>
          ))}
        </div>
      </div>
