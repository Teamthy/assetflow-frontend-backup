...
export function StandardStaffDashboard() {
  ...
  const assets = (assignedAssets?.data?.data ?? assignedAssets?.data?.items ?? assignedAssets?.data ?? [])
  const notificationsList = (notifications?.data?.data ?? notifications?.data?.items ?? notifications?.data ?? [])
