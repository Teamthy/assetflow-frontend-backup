  ...
  return (
    <div className="space-y-8 animate-fade-in">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <StatCard label="In Maintenance" value={summary?.maintenanceCount ?? 0} icon={AlertTriangle} iconColor="text-amber-600" iconBg="bg-amber-50" href="/maintenance" />
        <StatCard label="Data Issues" value={(summary?.missingSerialNumber ?? 0) + (summary?.missingCategory ?? 0)} icon={AlertTriangle} iconColor="text-red-600" iconBg="bg-red-50" href="/reports/audit" />
        <StatCard label="Disposed" value={summary?.disposedCount ?? 0} icon={ArrowLeftRight} iconColor="text-slate-500" iconBg="bg-slate-100" />
      </div>
